...
Welcome! We are glad you are interested in contributing to `dd-sts-action`. This guide will help you understand the requirements and guidelines to improve your contributor experience.
...
If you think you have found a bug in `dd-sts-action` feel free to report it. When creating issues, you will be presented with a template to fill. Please, fill as much as you can from that template, including steps to reproduce your issue, so we can address it quicker.
